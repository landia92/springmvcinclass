...
public class UserRestController {
    ...
    public ResponseEntity<UserDTO> patchUser(@PathVariable Long id, @RequestBody User user) {
        ...
        UserDTO patchedUser = userService.patchUser(id, user);
    ...
    @PostMapping("/bmi")
    public ResponseEntity<UserBmiDTO> createUserBmi(@RequestBody User user) {
        UserBmiDTO savedUser = userService.createUserBmi(user);
        return ResponseEntity.status(HttpStatus.CREATED).body(savedUser);
    }

    @PutMapping("/{id}/bmi")
    public ResponseEntity<UserBmiDTO> updateUserBmi(@PathVariable Long id, @RequestBody User user) {
        UserBmiDTO updatedUser = userService.updateUserBmi(id, user);
        return ResponseEntity.ok(updatedUser);
    }

    @PatchMapping("/{id}/bmi")
    public ResponseEntity<UserBmiDTO> patchUserBmi(@PathVariable Long id, @RequestBody User user) {
        UserBmiDTO patchedUser = userService.patchUserBmi(id, user);
        return ResponseEntity.ok(patchedUser);
    }
}