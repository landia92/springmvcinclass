...
public class ReqDataController {
    ...
    public String example1(HttpServletRequest request){
        //http://localhost:8080/req-data-check/example1?param1=value1&param2=2
    ...
    {//http://localhost:8080/req-data-check/example3-reqparam?param1=abc&param2=123
        return param1 + " / " + param2;
    }
    ...
    {//http://localhost:8080/req-data-check/example3-reqparam2?param2=123
        return param1 + " / " + param2;
    }
